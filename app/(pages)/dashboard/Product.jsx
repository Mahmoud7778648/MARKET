...
export const Products = () => {
  ...
  useEffect(() => {
    AOS.init({ duration: 1000, once: true }); // تهيئة AOS هنا

    const getData = async () => {
      const res = await fetch("https://9mkvjl-3001.csb.app/api/getproducts");
      if (!res.ok) {
  ...
  return (
    <div className="bg-gray-100 justify-center flex  border-8 align-middle relative left-auto m-auto w-10/12 mt-7 mb-15 h-auto gap-1 flex-wrap">
